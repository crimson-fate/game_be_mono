...
import { TextChangedProcessor } from './processor/textChanged.processor';
import {
  EthNameRecord,
  EthNameRecordSchema,
...
@Module({
  ...
  providers: [DetectionService, Web3Service, TextChangedProcessor],
})
export class TextChangedModule {}
