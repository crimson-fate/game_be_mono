import { MetadataSchema } from '@app/shared/models/metadata.schema';
...
import { RegisterProcessor } from './processor/register.processor';
import {
  EthNameRecord,
  EthNameRecordSchema,
} from '@app/shared/models/records.schema';
import { Metadata } from '@app/shared/models/metadata.schema';
...
@Module({
  ...
  providers: [DetectionService, Web3Service, RegisterProcessor],
})
