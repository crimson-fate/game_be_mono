...
import { UpdateMetaIPProcessor } from './processor/update.processor';
...
@Module({
  ...
  providers: [DetectionService, Web3Service, UpdateMetaIPProcessor],
})
export class UpdateMetaIPModule {}
